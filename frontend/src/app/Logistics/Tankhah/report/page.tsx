...
export default function Report() {
    ...
    const onFinish = (values) => {
        api().url(`/api/pettycashreport/`).post({start_date: Start_date, end_date: End_date}).json().then(value => {
                console.log(value);
                set_report(value);
            ...
            >
                <Row gutter={50}>
                    <Col span={6}>
                        ...
                        <Form.Item name="start_date" label="تاریخ شروع">
                            <DatePickerJalali
                                // value={form_date}
                    ...
                    <Col span={6}>
                        <Form.Item name="end_date" label="تاریخ پایان">
                            <DatePickerJalali
                                // value={form_date}
                                // defaultValue={form_date}
